...
public class OAuthAuthenticationToken implements AuthenticationToken, org.seedstack.seed.security.AuthenticationToken {
    ...
    public OAuthAuthenticationToken(JWT idToken, AccessToken accessToken) {
     ...
     * purposes. The identity is extracted from the subject (sub) claim but SHOULD NOT BE TRUSTED as the id token
     * may NOT be validated at this stage.
     *
